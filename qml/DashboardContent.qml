...
Item {
    ...
    Image {
        ...
        source: root.assetUrl("panels/Panel.png")
        ...
        Item {
            ...
            Image {
                id: topBar
                source: root.assetUrl("panels/Top Bar.png")
                ...
                RowLayout {
                    ...
                    Image {
                        width: 41
                        height: 20
                        source: root.assetUrl("icons/cloud.svg")
            ...
            Image {
                ...
                anchors.verticalCenter: parent.verticalCenter
                source: root.assetUrl("panels/Tacometer.png")
                fillMode: Image.PreserveAspectFit
                smooth: true
                mipmap: true
            ...
            Image {
                ...
                anchors.verticalCenterOffset: 100
                anchors.verticalCenter: parent.verticalCenter
                source: root.assetUrl("panels/Speedometer.png")
                fillMode: Image.PreserveAspectFit
                smooth: true
                mipmap: true
            ...
            Image {
                id: leftLevelIcon
                source: root.assetUrl("icons/feaul.svg")
                ...
                Item {
                    ...
                    Item {
                        ...
                        Image {
                            id: leftMaskImage
                            anchors.fill: parent
                            source: root.assetUrl("icons/Vector 1.png")
                            visible: false
                        }
            ...
            Image {
                id: rightLevelIcon
                source: root.assetUrl("icons/desal.svg")
            ...
            Image {
                ...
                source: root.assetUrl("icons/bottom.png")
                anchors.horizontalCenter: parent.horizontalCenter
                anchors.bottom: parent.bottom
